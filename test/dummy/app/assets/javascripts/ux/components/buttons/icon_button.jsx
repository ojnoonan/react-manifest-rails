...
const IconButton = (props) => {
  ...
  const variant = variantClasses[props.variant || 'ghost'] || variantClasses.ghost;
  const cls = [
  ...
  return React.createElement('button', {
    ...
    React.createElement('span', { 'aria-hidden': 'true', className: 'text-base leading-none' }, props.icon || '•')
  );
};
